...
func WriteHtml() {
	...
	for _, filename := range dirList {
		...
		contTrImgResTr := htmbody.Tr().Align("center").Attr("style", "color:black;width:600px;hight:200px")
		contTrImgResTr.Td().Colspan("4").Img().Src(dir+"\\"+filename.Name()).Attr("style", "width:600px;hight:200px")
